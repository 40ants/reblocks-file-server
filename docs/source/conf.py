# -*- coding: utf-8 -*-
#
# weblocks-file-server documentation build configuration file, created by
...
cl_systems = [
    {
        'name': 'weblocks-file-server-test',
...
project = u'weblocks-file-server'
...
htmlhelp_basename = 'weblocks-file-serverdoc'
...
latex_documents = [
  ('index', 'weblocks-file-server.tex', u'weblocks-file-server Documentation',
...
man_pages = [
    ('index', 'weblocks-file-server', u'weblocks-file-server Documentation',
...
texinfo_documents = [
  ('index', 'weblocks-file-server', u'weblocks-file-server Documentation',
   u'Alexander Artemenko', 'weblocks-file-server', '',
   'Miscellaneous'),
]
